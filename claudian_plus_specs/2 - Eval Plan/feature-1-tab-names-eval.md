...
**Spec:** `claudian_plus_specs/1 - Spec/feature-1-tab-names-spec.md`
**Autotest detail:** `claudian_plus_specs/2 - Implementation Plan/autotest-plan.md` (Feature 1 section)
