# Autotest Plan — AM Patch Features

Reference specs:
- `AM Patch/1 - Spec/feature-1-tab-names-spec.md`
- `AM Patch/1 - Spec/feature-2-usage-footer-spec.md`

Reference implementation plans:
- `AM Patch/2 - Implementation Plan/feature-1-tab-names-plan.md`
- `AM Patch/2 - Implementation Plan/feature-2-usage-footer-phase-1-core-codex.md`
- `AM Patch/2 - Implementation Plan/feature-2-usage-footer-phase-2-opencode.md`
- `AM Patch/2 - Implementation Plan/feature-2-usage-footer-phase-3-ocg-workers.md`
- `AM Patch/2 - Implementation Plan/feature-2-usage-footer-phase-4-future-providers.md`
