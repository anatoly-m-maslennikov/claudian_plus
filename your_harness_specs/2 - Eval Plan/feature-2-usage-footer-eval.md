...
**Spec:** `your_harness_specs/1 - Spec/feature-2-usage-footer-spec.md`
**Autotest detail:** `your_harness_specs/2 - Implementation Plan/autotest-plan.md` (Feature 2 section)
